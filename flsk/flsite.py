...
DEBUG = True
SECRET_KEY = '8b3b85150bd3de2cbd2081ddbbe8b6663863dda4'
...
@app.route('/')
@app.route('/index')  # создание корневого каталога
def index():
    db = get_db()
    dbase = FDataBase(db)
...
@app.route('/about')  # создание следующей страницы
def about():
    print(url_for('about'))
...
@app.errorhandler(404)  # обработчик перехода на несуществующую страницу
